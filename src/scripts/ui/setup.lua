...
function starmourn.ui.create_background()
  ...
  starmourn.ui.adj.top = Adjustable.Container:new({name = 'starmourn.ui.adj.top', x = '25%', y = 0, width = '50%', height = '170px', autoLoad = false })
  starmourn.ui.adj.bottom = Adjustable.Container:new({name = 'Gauges', x = '25%', y = '90%', width = '50%', height = '10%', })
  starmourn.ui.adj.left = Adjustable.Container:new({name = 'Starchart', x = '25%', y = '5%', width = '61c', height = '40c', })
  starmourn.ui.adj.right = Adjustable.Container:new({name = 'Beacon', x = '25%+61c', y = '5%', width = '82c', height = '25%', })
  ...
  starmourn.ui.left = Geyser.Label:new({ name = 'starmourn.ui.left', x = 0, y = 0, width = '100%', height = '100%', }, starmourn.ui.adj.left)
  starmourn.ui.left:setStyleSheet(backgroundcss:getCSS())

  starmourn.ui.right = Geyser.Label:new({ name = 'starmourn.ui.right', x = 0, y = 0, width = '100%', height = '100%', }, starmourn.ui.adj.right)
  starmourn.ui.right:setStyleSheet(backgroundcss:getCSS())

  starmourn.ui.top = Geyser.Label:new({ name = 'starmourn.ui.top', x = 0, y = 0, width = '100%', height = '100%', }, starmourn.ui.adj.top)
  starmourn.ui.top:setClickCallback(starmourn.ui.room_desc.click)
  starmourn.ui.top:setCursor("ResizeVertical")

  starmourn.ui.bottom = Geyser.Label:new({ name = 'starmourn.ui.bottom', x = 0, y = 0, width = '100%', height = '100%', }, starmourn.ui.adj.bottom)
...
function starmourn.ui.create_borders()
  ...
  for _, container in pairs(containers) do
    ...
    local bottom = Geyser.Label:new({ name = container.."bottom", x = 0, y = "100%-11px", width = '100%', height = '11px'}, starmourn.ui.adj[container])
    bottom:setStyleSheet([[
      border-image: url(]]..getMudletHomeDir()..[[/@PKGNAME@/bottom.png);
    ]])

    local right = Geyser.Label:new({ name = container.."right", x = "100%-35px", y = "42px", width = '35px', height = '100%-53px'}, starmourn.ui.adj[container])
    right:setStyleSheet([[
      border-image: url(]]..getMudletHomeDir()..[[/@PKGNAME@/right.png);
    ]])

    local left = Geyser.Label:new({ name = container.."left", x = 0, y = "42px", width = "34px", height = '100%-53px'}, starmourn.ui.adj[container])
    left:setStyleSheet([[
...
function starmourn.ui.create_boxes()
  ...
  starmourn.ui.adj = starmourn.ui.adj or {}
  starmourn.ui.adj.topright = Adjustable.Container:new({name = 'Chat', x = '75%', y = 0, width = '25%', height = '50%', fontSize = getFontSize() - 2})
  starmourn.ui.adj.bottomright = Adjustable.Container:new({name = 'Room Info', x = '75%', y = '50%', width = '25%', height = '50%',fontSize = getFontSize() - 2})
  starmourn.ui.adj.topleft = Adjustable.Container:new({name = 'Map', x = '0%', y = '0%', width = '25%', height = '75%', fontSize = getFontSize() - 2})
  starmourn.ui.adj.bottomleft = Adjustable.Container:new({name = 'Mindsim', x = '0%', y = '75%', width = '25%', height = '25%', fontSize = getFontSize() - 2})
  ...
  starmourn.ui.topright = Geyser.Label:new({ name = 'starmourn.ui.topright', x = 35, y = 30, width = '100%-70px', height = '100%-41px', fontSize = getFontSize() - 2}, starmourn.ui.adj.topright)
  starmourn.ui.topright:setStyleSheet(boxcss:getCSS())

  starmourn.ui.bottomright = Geyser.Label:new({ name = 'starmourn.ui.bottomright', x = 35, y = 30, width = '100%-70px', height = '100%-41px', fontSize = getFontSize() - 2}, starmourn.ui.adj.bottomright)
  starmourn.ui.bottomright:setStyleSheet(boxcss:getCSS())

  starmourn.ui.topleft = Geyser.Label:new({ name = 'starmourn.ui.topleft',  x = 35, y = 30, width = '100%-70px', height = '100%-41px', fontSize = getFontSize() - 2}, starmourn.ui.adj.topleft)
  starmourn.ui.topleft:setStyleSheet(boxcss:getCSS())

  starmourn.ui.bottomleft = Geyser.Label:new({ name = 'starmourn.ui.bottomleft',  x = 35, y = 30, width = '100%-70px', height = '100%-41px',  fontSize = getFontSize() - 3}, starmourn.ui.adj.bottomleft)
...
function starmourn.ui.create_gauges(class)
  starmourn.ui.footer = Geyser.VBox:new({ name = "starmourn.ui.footer", x = 0, y = 0, width = "100%", height = "100%", }, starmourn.ui.bottom)

  starmourn.ui.hp_box = Geyser.HBox:new({ name = "starmourn.ui.hp_box", }, starmourn.ui.footer)
  starmourn.ui.char = Geyser.HBox:new({ name = "starmourn.ui.char", x = 0, y = 0, width = "100%", height = "100%", }, starmourn.ui.footer)
...
function starmourn.ui.update_mindsim()
  ...
  if not starmourn.ui.footer then starmourn.ui.create_gauges(class) end
  if gmcp.IRE and gmcp.IRE.Target and type(gmcp.IRE.Target.Info) == 'table' and gmcp.IRE.Target.Info.hpperc ~= '' then
    ...
    local target_name = table.n_filter(starmourn.ui.info.room_items, function(item) return item.id == gmcp.IRE.Target.Info.id end)
    starmourn.ui.target:setValue(tonumber(target_hp_raw), 100, '<center><font color="LightGrey"><font color="LightGrey">' .. target_name[1].name)
  else
    starmourn.ui.target:setValue(0, 100, '<center><font color="LightGrey"><font color="LightGrey">No target')
  end

  starmourn.ui.health:setValue(tonumber(gmcp.Char.Vitals.hp), tonumber(gmcp.Char.Vitals.maxhp), '<center><font color="LightGrey"><font color="LightGrey">Health: ' .. string.format('%s / %s', gmcp.Char.Vitals.hp, gmcp.Char.Vitals.maxhp))

  if class == 'Nanoseer' then
    starmourn.ui.nanites:setValue(tonumber(gmcp.Char.Vitals.nn), tonumber(gmcp.Char.Vitals.maxnn), '<center><font color="LightGrey">Nanites: ' .. gmcp.Char.Vitals.formatnn)
    starmourn.ui.sanity:setValue(tonumber(gmcp.Char.Vitals.sa), tonumber(gmcp.Char.Vitals.maxsa), '<center><font color="LightGrey">Sanity: ' .. gmcp.Char.Vitals.formatsa)
  elseif class == 'Engineer' then
    starmourn.ui.parts:setValue(tonumber(gmcp.Char.Vitals.pt), tonumber(gmcp.Char.Vitals.maxpt), '<center><font color="LightGrey">Parts: ' .. gmcp.Char.Vitals.formatpt)
  elseif class == 'B.E.A.S.T.' then
    starmourn.ui.plasma:setValue(tonumber(gmcp.Char.Vitals.pl), tonumber(gmcp.Char.Vitals.maxpl), '<center><font color="LightGrey">Plasma: ' .. gmcp.Char.Vitals.formatpl)
  elseif class == 'Scoundrel' then
    starmourn.ui.bullets:setValue(tonumber(gmcp.Char.Vitals.bl), tonumber(gmcp.Char.Vitals.maxbl or 8), '<center><font color="LightGrey">Bullets: ' .. gmcp.Char.Vitals.formatbl)
  elseif class == 'Fury' then
    starmourn.ui.rage:setValue(tonumber(gmcp.Char.Vitals.rg), 1000, '<center><font color="LightGrey">Rage: ' .. gmcp.Char.Vitals.formatrg)
  end
  ...
  if not (gmcp.Char.Vitals.ship_bearing == nil) then
    ...
    <table align="center">
      ...
      <tr>
        ...
        <td>
          <font color="]]..get_system_color(hull_perc)..[[">]]..hull_perc..[[</font> ]]..[[<font color = "cyan">(</font><font color="]]..get_system_color(shields_perc)..[[">]]..shields_perc..[[</font><font color = "cyan">)</font>
        </td>
        <td align="right">
    ...
    <table align="center">
      <tbody>
        <tr>
          ...
          <td>
            <font color="]]..get_system_color(gmcp.Char.Vitals.wetwiring)..[[">]]..gmcp.Char.Vitals.wetwiring..[[</font>&nbsp;(<font color="]]..get_system_color(gmcp.Char.Vitals.wetwiring_efficacy)..[[">]]..gmcp.Char.Vitals.wetwiring_efficacy..[[</font>)]]..[[
          </td>
        </tr>
        <tr>
          <td align="right">
          ...
          <td>
            <font color="]]..get_system_color(gmcp.Char.Vitals.muscular)..[[">]]..gmcp.Char.Vitals.muscular..[[</font>&nbsp;(<font color="]]..get_system_color(gmcp.Char.Vitals.muscular_efficacy)..[[">]]..gmcp.Char.Vitals.muscular_efficacy..[[</font>)]]..[[
          </td>
        </tr>
        <tr>
          <td align="right">
          ...
          <td>
            <font color="]]..get_system_color(gmcp.Char.Vitals.internal)..[[">]]..gmcp.Char.Vitals.internal..[[</font>&nbsp;(<font color="]]..get_system_color(gmcp.Char.Vitals.internal_efficacy)..[[">]]..gmcp.Char.Vitals.internal_efficacy..[[</font>)]]..[[
          </td>
        </tr>
        <tr>
          <td align="right">
          ...
          <td>
            <font color="]]..get_system_color(gmcp.Char.Vitals.sensory)..[[">]]..gmcp.Char.Vitals.sensory..[[</font>&nbsp;(<font color="]]..get_system_color(gmcp.Char.Vitals.sensory_efficacy)..[[">]]..gmcp.Char.Vitals.sensory_efficacy..[[</font>)]]..[[
          </td>
        </tr>
        <tr>
          <td align="right">
          ...
          <td>
            <font color="]]..get_system_color(gmcp.Char.Vitals.mind)..[[">]]..gmcp.Char.Vitals.mind..[[</font>&nbsp;(<font color="]]..get_system_color(gmcp.Char.Vitals.mind_efficacy)..[[">]]..gmcp.Char.Vitals.mind_efficacy..[[</font>)]]..[[
          </td>
        </tr>
      </tbody>
    </table>
