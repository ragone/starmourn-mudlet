...
starmourn.ui.mapper:decho(
	"Space",
	string.format(
		"<192,192,192:0,0,0>Spd:%3s<250,250,250:0,0,0> <230,180,20:0,0,0>Hull:"
			.. get_system_color(hull_perc)
			.. "%3s<250,250,250:0,0,0> <60,160,255:0,0,0>Shld:"
			.. get_system_color(shields_perc)
			.. "%3s<250,250,250:0,0,0><215,60,170:0,0,0> Cap:<192,192,192:0,0,0>%3s%%",
		vitals.ship_speed,
		vitals.ship_hull,
		vitals.ship_shield,
		cap
